  ...
  <nav class="navbar navbar-expand-xl navbar-light p-0 m-0">
    <div class="d-flex justify-content-between justify-content-xl-start pe-2 p-xl-0 navbar-width">
      <div
        ...
        <img
          src="{{ asset('public/header/images/Black_Sedan_logo.png') }}"
          alt=""
      ...
      <div
        ...
        <ul class="navbar-nav mt-4 px-3">
          ...
          <li class="nav-item border-bottom py-3">
            <a class="p-0 nav-link" aria-current="page" href="{{url('/about-us')}}"
              >About Us</a
            >
          </li>
          <li class="nav-item border-bottom py-3">
            <a class="p-0 nav-link" aria-current="page" href="{{url('/our-services')}}"
              >Our Services</a
            >
          </li> 
          <li class="nav-item border-bottom py-3">
      ...
      <div class="d-none d-xl-flex flex-column align-items-start ms-5 w-100">
        ...
        <div style="width: 91%" class="d-flex align-items-center justify-content-between navbar-bottom-section">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body text-center">
              ...
              <div class="py-2 mb-3">
                  ...
                  <a href="{{route('chauffeur.login')}}" class="mt-3 mt-sm-0 ms-sm-3 px-4 py-3 btn bg-black text-white">
...
{{-- Book Now modal --}}
<div class="modal fade" id="bookNowModal1" tabindex="-1" role="dialog" aria-labelledby="bookNowModalLabel1" aria-hidden="true">
  <div class="modal-dialog d-flex align-items-center h-75" role="document">
      <div class="modal-content">
          <div class="modal-header border-0 d-flex justify-content-end">
              <button type="button" data-bs-dismiss="modal" aria-label="Close" class="d-flex justify-content-center bg-black border-0 text-white rounded align-items-center" style="height: 3rem; width: 4rem; position: absolute; top:0.5rem; right:0.5rem;">
