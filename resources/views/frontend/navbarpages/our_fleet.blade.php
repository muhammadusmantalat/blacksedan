...
@section('meta')
    ...
    <link rel="canonical" href="https://blacksedans.ca/blacksedans/our-fleet/" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Black Sedan Fleet | Calgary Airport Limo | Vancouver Airport Limousine" />
    <meta property="og:description"
        content="When it comes to reserving a limo ride, Black Sedan is the name which you can trust. Weprovided with the highest level of quality service" />
    <meta property="og:url" content="https://blacksedans.ca/blacksedans/our-fleet/" />
                ...
                <div class="fleet-card">
                    <div class="p-3 h-100 fleet-card-inner">
                        ...
                        <div class="p-3">
                            ...
                            <br>
                            <br>
                            <p class="mb-0 fw-bold">Please note: 2 days in advance booking and advance payment required!
                            </p>
                            <div class="mt-4">
                                <a href="{{ $signIn ? $booknow : '#bookNowModal' }}"
                                    data-bs-toggle="{{ !$signIn ? 'modal' : '' }}" class="btn-4 rounded">
